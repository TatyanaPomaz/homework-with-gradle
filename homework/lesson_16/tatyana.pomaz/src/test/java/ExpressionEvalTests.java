...
public class ExpressionEvalTests {
  ...
  @Test
  public void testExpressionWithTwoDigitNumber() throws Exception {

    assertThat(expression.evaluate("(33 + ((4 * 2) / (4 - 8)))"), is(31.0));
	assertThat(expression.evaluate("(15 + ((8 / 2) * (4 / 2)))"), is(23.0));
	assertThat(expression.evaluate("(1 + (20 / 4))"), is(6.0));
  }
  
  @Test
  public void testExpressionWithThreeDigitNumber() throws Exception {

    assertThat(expression.evaluate("(331 + ((422 * 2) / (4 - 8)))"), is(120.0));
	assertThat(expression.evaluate("(15 + ((8 / 2) * (400 / 2)))"), is(815.0));
	assertThat(expression.evaluate("(151 + (20 / 4))"), is(156.0));
  }
}
